...
export const fetchAllRestaurants = () => {
  return Axios.get('https://ptx.transportdata.tw/MOTC/v2/Tourism/Restaurant?$format=JSON', {
...
export const fetchCityRestaurants = city => {
  ...
  return Axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/Restaurant/${city}?&$format=JSON`, {
    headers: getAuthorizationHeader(),
  })
    .then(response => {
      const { data } = response;
