...
const ActivitiesPage = () => {
  const { loading, setLoading, activities, setActivities, currentItems, setCurrentItems } = useDataContext();
            ...
            <Col md={9}>
              ...
              <Row>
                <Col className="d-flex justify-content-center">
                  <PaginatedItems itemsPerPage={9} items={activities} setCurrentItems={setCurrentItems} />
                </Col>
              </Row>
            </Col>
          )}
