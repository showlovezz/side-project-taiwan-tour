...
const HotelsPage = () => {
  const { loading, setLoading, hotels, setHotels, currentItems, setCurrentItems } = useDataContext();
            ...
            <Col md={9}>
              ...
              <Row>
                <Col className="d-flex justify-content-center">
                  <PaginatedItems itemsPerPage={9} items={hotels} setCurrentItems={setCurrentItems} />
                </Col>
              </Row>
            </Col>
          )}
