...
import { fetchAllHotels, fetchCityHotels, fetchKeyWordWithCityHotels, fetchKeyWordHotels } from '../api';
...
const SearchForm = () => {
  ...
  return (
    <section className="hotels-page__search">
      <Formik initialValues={{ key_word: '', city: '' }} validationSchema={validationSchema} onSubmit={handleSubmit}>
        <FormikForm>
          <Row className="mb-3">
            <Form.Group as={Col}>
              <InputField name="key_word" className="hotels-page__search-input" />
            </Form.Group>
          </Row>
          <Row className="mb-3">
            <Form.Group as={Col}>
